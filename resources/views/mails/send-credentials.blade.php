                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="{{ url('/') }}" title="logo" target="_blank">
                                <img width="60" src="{{ asset(setting('company_logo_small')) }}"
                                    title="logo" alt="logo">
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p
                                            ...
                                            <strong
                                                style="display: block;font-size: 13px; margin: 0 0 4px; color:rgba(0,0,0,.64); font-weight:normal;">Username</strong> {{ $details['email'] }}
                                            <strong
                                                style="display: block; font-size: 13px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">Password</strong> {{ $details['password'] }}
                                        </p>
