                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="text-center">
                                            ...
                                            <h2 class="text-center">Generate Password?</h2>
                                            <p>You can reset your password here.</p>
                                            <div class="panel-body">

                                                <form id="register-form" role="form" autocomplete="off"
                                                    class="form"
                                                    method="post"action="{{ route('password.update') }}" style="display: flex;flex-direction: row; gap: 41px;"> 

                                                    @csrf
                                                    <input id="email" name="email" placeholder="email address"
                                                        class="form-control" value="{{ $email }}" type="hidden">
                                                         <input id="token" name="token" placeholder="email address"
                                                        class="form-control" value="{{ $token }}" type="hidden">
                                                    <div class="form-group">
                                                        <div class="input-group" style="position: relative;display: flex;align-items: stretch;width: 100%;gap: 8px;">
